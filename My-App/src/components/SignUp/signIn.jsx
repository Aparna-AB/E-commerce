...
//     mobNum: yup.string().required("Field is required"),
...
//   // const [mobNumEmpty, setMobNumEmpty] = useState(true);
...
//     if (firstName.length > 0 && lastName.length > 0 && userName.length > 0 && mobNum.length > 0) {
...
//         <NavBar />
//       </div>
//       <div className="container-1 lg-12">
...
//                   <Form.Label className="formLabel">Mobile</Form.Label>
//                   <Form.Control
//                     type="text"
//                     name="mobNum"
//                     value={values.mobNum}
...
//                     }}
//                     isValid={touched.mobNum && !errors.mobNum}
//                     isInvalid={touched.mobNum && !!errors.mobNum}
//                     className="input3"
//                   />
//                   <Form.Control.Feedback type="invalid">
//                     {errors.mobNum}
...
//                   {/* <InputGroup.Text id="inputGroupPrepend" style={{width:"40px",height:"30px",marginLeft:"80px"}}>@</InputGroup.Text> */}
//                   <Form.Control
//                     type="text"
...
//                 </Form.Group><br />
//                 <Button type="submit" className="btn1">Submit form</Button>
//                 <Button onClick={existUser} className="btn2">Existing User? Log In</Button>
//               </Form>
//             )}
//           </Formik>
//         </div>
